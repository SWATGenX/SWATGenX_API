...
[![Public repo](https://img.shields.io/badge/GitHub-SWATGenX%2FSWATGenX_API-181717?style=flat-square&logo=github)](https://github.com/SWATGenX/SWATGenX_API)
...
2. **Resource owner:** the **`SWATGenX`** organization (or your user, if the token is user-scoped and you have repo access).
3. **Repository access:** select **only** `SWATGenX/SWATGenX_API` (or “All repositories” if you accept broader scope).
4. **Permissions:**
